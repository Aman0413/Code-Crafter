const resetPasswordTemplate = (link) => {
  return `<!DOCTYPE html>
    ...
    <div style="border-bottom:5px solid #eee">
      <a href="" style="font-size:30px;color: #f7c800;text-decoration:none;font-weight:600">CodeCrafter</a>
    </div>
   
    <p style="font-size:15px">We have received a request to reset your password for your CodeCrafter account. To complete the password reset process, please follow the link below:
   </p>
    ...
    <p style="font-size:15px;">Regards,<br />Team CodeCrafter</p>
